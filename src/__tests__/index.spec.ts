                ...
                describe('and the interaction is a valid command', () => {
                    ...
                    describe('and the interaction is unsuccessful', () => {
                        ...
                        beforeEach(async () => {
                            ...
                            mockExecute.mockImplementation(() => { throw new Error(error) })
                        ...
                        describe('and the interaction was not replied', () => {
                            ...
                            it('then it replies with an error', () => {
                                expect(mockReply).toHaveBeenCalledWith({ content: 'There was an error while executing this command!', ephemeral: true })
                            })
                        })
                        describe('and the interaction was replied', () => {
                            ...
                            it('then it follows up with an error', () => {
                                expect(mockFollowUp).toHaveBeenCalledWith({ content: 'There was an error while executing this command!', ephemeral: true })
                            })
                        })
                    })
                })
